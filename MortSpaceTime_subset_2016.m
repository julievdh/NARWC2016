...
% plot right whales 
ii = find(VS(:,4) == 1);
plot(VS(ii(VS(ii)<2009),6)/1000,vsmday(ii(VS(ii)<2009)),'ro','markersize',9)
plot(VS(ii(VS(ii)>=2009),6)/1000,vsmday(ii(VS(ii)>=2009)),'ro',...
    'MarkerSize',9,'MarkerEdgeColor','r','MarkerFaceColor','r')
plot(MEAS2016(Eg,6)/1000,mday2016(Eg),'ro','MarkerSize',9,'MarkerEdgeColor','r',...
    'MarkerFaceColor','r')
